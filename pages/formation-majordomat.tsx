  ...
  return (
    <>
      <Head>
        ...
        <MetaSite>
          <meta name="description" content="Formez-vous aux métiers du majordomat, en rejoignant notre équipe qualifiée et pédagogue avec des modules de qualité. Formation certifiante et financée, vous prépare à vous démarquer sur le marché de l’emploi."/>
