...
const DatesSessions = () => {
  ...
  return (
    <section id="dates-sessions">
      ...
      <p>
        La formation d'Assistant(e) de Vie aux Familles (advf) s'adresse à toute personne souhaitant se former pour exercer ce métier. En effet, étant donné
