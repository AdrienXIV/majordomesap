...
const DatesSessions = () => {
  ...
  return (
    <section id="dates-sessions">
      ...
      <p>La formation majordomat, vous permet d'obtenir les bases et la polyvalence d'un majordome. Lors de cette formation, vous acquerrez une vision globale du métier de majordome et des compétences indispensables pour y exercer dans les métiers du luxe. Vous apprendrez les savoir-être, le rôle du majordome et ses relations avec le personnel.</p>
      <p>La formation d'Assistant(e) de Vie aux Familles s'adresse à toute personne souhaitant se former pour exercer ce métier. En effet, étant donné que le secteur de l'aide à domicile est en perpétuel essor, les emplois dans ce domaine ne manquent pas.</p>
